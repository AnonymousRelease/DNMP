...
PRETRAIN_GEO_05['seq_3']='pretrained/geometries/v0.5_seq_3.pth'
PRETRAIN_GEO_10['seq_3']='pretrained/geometries/v1.0_seq_3.pth'
...
--num_faces 4 \
--coarse_num_faces 2 \
--pretrained_mesh_ae pretrained/mesh_ae/mesh_ae.pth \
